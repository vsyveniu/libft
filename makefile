...
SRC	 = 	ft_memset.c ft_bzero.c ft_memcpy.c ft_memccpy.c ft_memmove.c ft_memchr.c ft_memcmp.c \
		...
		ft_strchr.c ft_strstr.c ft_strnstr.c ft_strcmp.c ft_strncmp.c ft_atoi.c ft_isalpha.c \
		...
		ft_putendl_fd.c ft_putnbr_fd.c ft_putnbr_fd.c ft_itoa.c ft_strrchr.c ft_lstnew.c ft_lstdelone.c\
